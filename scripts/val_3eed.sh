TORCH_DISTRIBUTED_DEBUG=INFO CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node 1 --master_port $RANDOM \
    ...
    --dataset m3ed-quad m3ed-drone waymo --test_dataset m3ed-quad m3ed-drone waymo \
    ...
    --eval \
    --checkpoint_path /home/rongl/code/3eed/logs/ours_debug/m3ed-quad,m3ed-drone,waymo/1747376130/ckpt_epoch_10.pth \